...
-- ------------------------------------------------------------
-- 5. EncargadoRestaurante (viene de usuario)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Usuarios
--   contrasena: 'password123' (en producción usar hash bcrypt)
-- ------------------------------------------------------------
...
-- Restaurantes
-- ------------------------------------------------------------
INSERT INTO Restaurante (nombre, cedula_juridica, direccion, tipo_comida, latitud, longitud, imagen ) VALUES
('Burguer Tico',     '3-101-000001', 'Heredia Centro, 100m norte del parque', 'Hamburguesas', 9.9990, -84.1160, NULL ),
('Pizza Heredia',    '3-101-000002', 'Barrio Los Ángeles, Heredia',           'Pizza',        10.0010, -84.1180, NULL);

-- ------------------------------------------------------------
-- EncargadoRestaurante
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Combos
--   Precios fijos: combo 1=₡4000 ... combo 9=₡12000
--   (incremento de ₡1000 por número)
-- ------------------------------------------------------------
-- Burguer Tico
...
-- ------------------------------------------------------------
-- Calificaciones (solo pedido 1, que ya fue ENTREGADO)
-- ------------------------------------------------------------
